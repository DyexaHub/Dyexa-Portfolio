...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    content:
      "Dyexa's attention to detail in UI/UX design and his commitment to creating seamless user experiences align with the values we hold dear. His work demonstrates that he understands technology should not only be powerful but also intuitive and accessible.",
    rating: 5,
    date: "Jun 2025",
  },
  {
